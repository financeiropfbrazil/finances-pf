...
### 2. BL-21 — endpoint de lotes disponíveis

Pré-requisito **da tela de atendimento** (a Fase 3), não da criação. É a última peça faltante do fluxo completo (§10.21), e o protocolo de captura está no próprio BL-21 — **Preserve log ligado ANTES de abrir a seleção de lote**, que escapou de três tentativas.
