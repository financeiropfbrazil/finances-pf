...
| OP-2.2 | DDL do espelho de RM — `sql/OP-2.2.sql`, aplicado pelo Pedro no SQL Editor | EM ANDAMENTO | 04/08/2026 | SQL entregue em `sql/OP-2.2.sql` (04/08/2026). Aguarda aplicação no SQL Editor pelo Pedro. Schema; diferenças vs `compras_pedidos` na §10.12. |
