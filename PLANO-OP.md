...
| OP-1.2 | RLS + RPCs de escrita | EM ANDAMENTO | 23/07/2026 | **SQL redigido e revisado em `sql/OP-1.2.sql`** (não assume schema: `hub_*` lidos ao vivo). Aguarda **Pedro colar no SQL Editor + verificação** → então CONCLUÍDA. |
