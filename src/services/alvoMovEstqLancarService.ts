...
function buildPayload(input: LancarNfseInput, anexos: { uuid: string; tipo: 'pdf' | 'xml' }[]): any {
  ...
  return {
    ...
    ValorMercadoria: 0, ValorFinalMercadoria: 0,
...
export async function lancarNfseNoAlvo(
  ...
  // Gerar UUIDs para os anexos disponíveis
