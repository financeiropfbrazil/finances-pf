...
async function buildPayload(input: LancarNfseInput, token: string): Promise<any> {
  ...
  const item: any = {
    ...
    FatorDivisor: 1, BaseCustoMedio: v, CustoUnitario: v,
    ChaveOrdenacao: 0, SequenciaItemContrato: 0, NumeroVersaoContrato: 0,
    SequenciaItemNotaFiscal: 1,
    CalculaST: "Não",
    ReducaoICMS: 0, ReducaoPIS: 0, ReducaoCOFINS: 0,
    ReducaoICMSST: 0, ReducaoIPI: 0,
    ItemValorCompararClasseReceitaDespesa: v,
    ItemMovEstqUserFieldsObject: {},
    CompItemMovEstqChildList: [],
    CtrlLoteItemMovEstqChildList: [],
    ItemMovEstqCctrlChildList: [],
    SerialItemMovEstqChildList: [],
  ...
  const classObject: any = {
    ...
    IcmsMovEstqChildList: [{
      CodigoEmpresaFilial: "1.01", Chave: 1, PercentualICMS: 0,
      BaseCalculoICMS: 0, ValorICMS: 0,
      IcmsMovEstqUserFieldsObject: {}, UploadIdentify: "",
    }],
