    ...
    <Routes>
      ...
      >
        ...
        <Route
          path="/receivables"
          element={
            <PermissionRoute permKey="receivables">
              <Receivables />
            </PermissionRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <PermissionRoute permKey="fixed_assets">
        ...
        <Route
          path="/commodatum"
          element={
            <PermissionRoute permKey="commodatum">
              <Commodatum />
            </PermissionRoute>
          }
        />
        <Route
          path="/nf-entrada"
          element={
            <PermissionRoute permKey="nf_entrada">
              <NfEntrada />
            </PermissionRoute>
          }
        />
        ...
        />
        <Route
          path="/suprimentos/requisicoes/nova"
          element={
            <PermissionRoute permKey="suprimentos_requisicoes">
              <SuprimentosRequisicaoNova />
            </PermissionRoute>
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <PermissionRoute permKey="compras.pedidos.view_all">
        ...
        <Route
          ...
          element={
            <PermissionRoute permKey="compras">
              <ComprasNotasFiscais />
            </PermissionRoute>
          }
        />
        <Route
          path="/compras/notas-servico"
          element={
            <PermissionRoute permKey="compras">
              <ComprasNotasServico />
            </PermissionRoute>
        ...
        <Route
          path="/entidades"
          element={
            <PermissionRoute permKey="entidades">
              <Entidades />
            </PermissionRoute>
          }
        />
        <Route
          path="/entidades/upload-codigos"
          element={
            <PermissionRoute permKey="entidades">
              <EntidadesUploadCodigos />
            </PermissionRoute>
          }
        />
        <Route
        ...
        <Route
          path="/contas-a-pagar"
          element={
            <PermissionRoute permKey="contas_pagar">
              <ContasPagar />
            </PermissionRoute>
          }
        />
        <Route
          path="/contas-a-pagar/dashboard"
          element={
            <PermissionRoute permKey="contas_pagar">
        ...
        <Route
          path="/loans"
          element={
            <PermissionRoute permKey="loans">
              <PlaceholderPage titleKey="nav.loans" />
            </PermissionRoute>
          }
        />
        <Route
        ...
        <Route
          path="/credit-cards"
          element={
            <PermissionRoute permKey="credit_cards">
              <CreditCards />
            </PermissionRoute>
          }
        />
        ...
        <Route
          path="/projetos"
          element={
            <PermissionRoute permKey="projetos">
              <Projetos />
            </PermissionRoute>
          }
        />
        ...
        <Route
          path="/closing"
          element={
            <PermissionRoute permKey="closing">
              <Closing />
            </PermissionRoute>
          }
        />
        <Route
          path="/settings/api"
          element={
            <PermissionRoute permKey="settings">
              <Settings />
            </PermissionRoute>
          }
        />
        ...
        />
        <Route
          path="/settings/classes-rec-desp"
          element={
            <PermissionRoute permKey="settings">
              <ClassesRecDesp />
            </PermissionRoute>
